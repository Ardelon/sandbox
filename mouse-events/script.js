(() => {
	...
	eventArea.addEventListener("click", (e) => {
		...
		const counterValue = Number(document.querySelector("#click-div p span").innerText);
	...
	eventArea.addEventListener("contextmenu", (e) => {
		...
		const counterValue = Number(document.querySelector("#contextmenu-div p span").innerText);
		document.querySelector("#contextmenu-div p span").innerText = counterValue + 1;
	});
	eventArea.addEventListener("dblclick", (e) => {
		...
		const counterValue = Number(document.querySelector("#dblclick-div p span").innerText);
	...
	eventArea.addEventListener("mousedown", (e) => {
		...
		const counterValue = Number(document.querySelector("#mousedown-div p span").innerText);
		document.querySelector("#mousedown-div p span").innerText = counterValue + 1;
	});
	eventArea.addEventListener("mouseenter", (e) => {
		...
		const counterValue = Number(document.querySelector("#mouseenter-div p span").innerText);
		document.querySelector("#mouseenter-div p span").innerText = counterValue + 1;
	});
	eventArea.addEventListener("mouseleave", (e) => {
		...
		const counterValue = Number(document.querySelector("#mouseleave-div p span").innerText);
		document.querySelector("#mouseleave-div p span").innerText = counterValue + 1;
	});
	eventArea.addEventListener("mousemove", (e) => {
		...
		const counterValue = Number(document.querySelector("#mousemove-div p span").innerText);
		document.querySelector("#mousemove-div p span").innerText = counterValue + 1;
	});
	eventArea.addEventListener("mouseout", (e) => {
		...
		const counterValue = Number(document.querySelector("#mouseout-div p span").innerText);
	...
	eventArea.addEventListener("mouseover", (e) => {
		...
		const counterValue = Number(document.querySelector("#mouseover-div p span").innerText);
		document.querySelector("#mouseover-div p span").innerText = counterValue + 1;
	});
	eventArea.addEventListener("mouseup", (e) => {
		...
		const counterValue = Number(document.querySelector("#mouseup-div p span").innerText);
